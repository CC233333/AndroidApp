...
import com.master.androidx.app.Versions;
...
public class StatusBars {
    ...
    private static void setStatusBarLight(Window window, boolean isLight) {
        if (Versions.api23()) {
            StatusBars.setStatusBarLight23(window, isLight);
        } else if (StatusBars.isMIUI()) {
            StatusBars.setMiUiStatusBarLight(window, isLight);
        } else if (StatusBars.isFlyme()) {
            StatusBars.setFlymeStatusBarLight(window, isLight);
        }
    }
